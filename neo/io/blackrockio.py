...
class BlackrockIO(BaseIO):
    ...
    def __read_nev_header(self, filehandle):
        ...
        # Read comments and remove 0's
        self.parameters_nev['Application'] = filehandle.read(32).split('\x00', 1).decode('UTF-8')[0]

        # Read comments and remove 0's
        self.parameters_nev['Comments'] = filehandle.read(256).split('\x00', 1).decode('UTF-8')[0]
